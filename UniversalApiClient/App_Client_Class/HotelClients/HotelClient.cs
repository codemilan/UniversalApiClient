...
namespace UniversalApiClient.Client
{
    class HotelClient
    {
        ...
        {
            get { return HotelClient.closestHotelCode; }
            set { HotelClient.closestHotelCode = value; }
        }

        public static String CheapestHotelCode
        {
            get { return HotelClient.cheapestHotelCode; }
            set { HotelClient.cheapestHotelCode = value; }
        }

        public static String RateSupplier
        {
            get { return HotelClient.rateSupplier; }
            set { HotelClient.rateSupplier = value; }
        }
