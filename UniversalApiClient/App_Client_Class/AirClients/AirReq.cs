    ...
    class AirReq
    {
        ...
        */
        ...
        internal static AirRetrieveDocumentRsp GetPNR(UniversalService.UniversalRecordRetrieveRsp univRetRsp)
        {
            ...
            {
                UniversalApiClient.UniversalService.AirReservation airRes = ob as UniversalApiClient.UniversalService.AirReservation;
                airResValueList.Add(new AirReservationLocatorCode() { Value = airRes.LocatorCode });
                airResList.Add((ItemsChoiceType1)Enum.Parse(typeof(ItemsChoiceType1), UniversalApiClient.AirService.ItemsChoiceType1.AirReservationLocatorCode.ToString()));
                docReq.ItemsElementName = airResList.ToArray();
